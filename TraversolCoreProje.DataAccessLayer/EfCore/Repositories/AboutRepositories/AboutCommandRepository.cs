...
{
    public class AboutCommandRepository : GenericCommandRepository<About>, IAboutCommandRepository
    {
        public AboutCommandRepository(AppDbContext appDbContext, IUnitOfWork unitOfWork) : base(appDbContext, unitOfWork)
        {
        }
    }
}
